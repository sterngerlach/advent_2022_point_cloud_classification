...
// inference_cls_naive_fail.hpp

#ifndef INFERENCE_CLS_NAIVE_FAIL_HPP
#define INFERENCE_CLS_NAIVE_FAIL_HPP
...
template <typename T>
void InitializeClsNaive(LinearParams<T, kClsDims0, kClsDims1>* fc1,
                        LinearParams<T, kClsDims1, kClsDims2>* fc2,
                        LinearParams<T, kClsDims2, kClsDims3>* fc3,
...
#pragma HLS INLINE off
  ...
  ReadBlockParamsNaive<T, kClsDims0, kClsDims1>(fc1, bn1, params1);
  ReadBlockParamsNaive<T, kClsDims1, kClsDims2>(fc2, bn2, params2);
  ReadLinearParamsNaive<T, kClsDims2, kClsDims3>(fc3, params3, 0);
}
...
void InferenceClsNaive(const T feature[kFeatDims5],
                       float* out_logits,
                       const LinearParams<U, kClsDims0, kClsDims1>* fc1,
                       const LinearParams<U, kClsDims1, kClsDims2>* fc2,
...
#pragma HLS INLINE off
  ...
  // Compute logits
  LinearNaive<T, U, kClsDims0, kClsDims1, false>(
    feature, x0, fc1->weight, fc1->bias);
  BatchNorm1dReLUNaive<T, U, kClsDims1>(
    x0, x1, bn1->scale, bn1->bias, bn1->mean);
  LinearNaive<T, U, kClsDims1, kClsDims2, false>(
    x1, x2, fc2->weight, fc2->bias);
...
#endif // INFERENCE_CLS_NAIVE_FAIL_HPP
