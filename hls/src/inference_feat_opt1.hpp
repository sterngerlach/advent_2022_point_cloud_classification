...
// inference_feat_opt1.hpp

#ifndef INFERENCE_FEAT_OPT1_HPP
#define INFERENCE_FEAT_OPT1_HPP
...
template <typename T>
void InitializeFeatOpt1(LinearParams<T, kFeatDims0, kFeatDims1>* conv1,
