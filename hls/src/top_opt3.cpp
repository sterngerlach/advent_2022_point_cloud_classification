...
#include "inference_cls_opt3.hpp"
#include "inference_feat_opt3.hpp"
...
#pragma HLS BIND_STORAGE variable=feat_conv5.weight type=RAM_2P impl=uram
  ...
  if (op_mode == kModeInitWeights) {
    ...
    InferenceFeatOpt3<value_t, param_t, 1024>(
      point_cloud, num_points, feature,
      &feat_conv1, &feat_conv2, &feat_conv3, &feat_conv4, &feat_conv5,
      &feat_bn1, &feat_bn2, &feat_bn3, &feat_bn4, &feat_bn5);

    // Run the classification
    InferenceClsOpt3<value_t, param_t>(
      feature, out_logits,
      &cls_fc3, &cls_bn1, &cls_bn2,
      cls_params1, cls_params2, cls_params3);
  }
